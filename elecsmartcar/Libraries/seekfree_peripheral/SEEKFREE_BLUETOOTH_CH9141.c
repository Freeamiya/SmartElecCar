...
static  fifo_struct     xdata bluetooth_ch9141_fifo = {0};
static  uint8           xdata bluetooth_ch9141_buffer[BLUETOOTH_CH9141_BUFFER_SIZE] = {0};  // 数据存放数组


//-------------------------------------------------------------------------------------------------------------------
//  @brief      ch9141蓝牙转串口模块 串口中断回调函数
//  @param      void
//  @return     void
//  Sample usage:
